...
class replay(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lora_lora_receiver_0 = lora.lora_receiver(1e6, 868e6, [868.3e6], 125000, 7, False, 4, True, False, False, 1, False, False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/dragonos/Documents/captured.bin', False)
